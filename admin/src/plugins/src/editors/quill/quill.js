    ...
    var t = {
          ...
          class m extends u.ScrollBlot {
            ...
            update(t) {
              ...
              "string" == typeof t && (e = t),
                ...
                t.length > 0 &&
                  this.emitter.emit(f.Z.events.SCROLL_UPDATE, e, t);
            }
            updateEmbedAt(t, e, n) {
        ...
        250: function (t, e, n) {
                ...
                return (
                  (function (t) {
                    ...
                    const f = u ? 1 : 0,
                      p = h ? 1 : 0;
                    return (
                      (e += f + p), i.retain(f), i.delete(p), t + l + f + p
                    );
                  }, 0),
                  i.reduce(
                    (t, e) =>
          ...
          class C {
            ...
            getSemanticHTML() {
              ...
              return (
                "number" == typeof t && (e = this.getLength() - t),
                ([t, e] = P(t, e)),
        ...
        1453: function (t, e, n) {
          ...
          const y = (0, l.Z)("quill:clipboard"),
                ...
                function (t, e) {
                  ...
                  if (null != n)
                    return w(
                      e,
                      "table",
                      Array.from(n.querySelectorAll("tr")).indexOf(t) + 1
                    );
                },
              ],
              ["b", L.bind(L, "bold")],
            ...
            N = [u.HE, h.w, f.HQ, p.H8, g.H, m.Z].reduce(
              (t, e) => ((t[e.keyName] = e), t),
              {}
            );
          class E extends a.Z {
        ...
        9907: function (t, e, n) {
          ...
          var V,
            ...
            X = (V = /[^.]+$/.exec((Q && Q.keys && Q.keys.IE_PROTO) || ""))
              ? "Symbol(src)_1." + V
              : "",
            J = G.toString,
            tt = Y.hasOwnProperty,
        ...
        8473: function (t, e, n) {
          ...
          const o = class {
            ...
            query(t, e = r.ANY) {
              ...
              return (
                ...
                null == n
                  ? null
                  : e & r.LEVEL & n.scope && e & r.TYPE & n.scope
                  ? n
                  : null
              );
            }
            register(...t) {
              ...
              const e = t[0];
              if (
                "string" != typeof e.blotName &&
                "string" != typeof e.attrName
              )
          ...
          const u = class extends a {
            ...
            replaceWith(t, e) {
              const n = "string" == typeof t ? this.scroll.create(t, e) : t;
              return (
                n instanceof u && this.moveChildren(n), super.replaceWith(n)
              );
            }
            split(t, e = !1) {
              if (!e) {
          ...
          class m extends p {
            ...
            value(t) {
              const e = (g(t, this.keyName)[0] || "").slice(
          ...
          class y extends p {
            ...
            add(t, e) {
              return (
                !!this.canAdd(t, e) && ((t.style[b(this.keyName)] = e), !0)
              );
            }
            remove(t) {
              (t.style[b(this.keyName)] = ""),
          ...
          const x = class extends h {
            ...
            format(t, e) {
              if (t !== this.statics.blotName || e) {
                ...
                this.children.forEach((t) => {
                  t instanceof x || (t = t.wrap(x.blotName, !0)),
          ...
          class Z extends h {
            ...
            optimize(t = [], e = {}) {
              ...
              const i = (t, e = !0) => {
                ...
                s = (t) => {
                  n.has(t.domNode) &&
                    (t instanceof h && t.children.forEach(s),
                    n.delete(t.domNode),
                    t.optimize(e));
                };
              let o = t;
    ...
    return (
      (function () {
        ...
        class W extends N.Z {
          ...
          format(t, e) {
            t !== W.blotName
              ...
              : (V.remove(this.domNode),
                this.domNode.classList.remove(this.statics.className));
          }
          optimize() {
            super.optimize(...arguments),
              V.value(this.domNode) || this.unwrap();
          }
        }
        ...
        class G extends M.ZP {
          ...
          replaceWith(t, e) {
            return (
              this.formatAt(0, this.length(), W.blotName, !1),
              ...
              (0, K.fw)(
                ...
                [
                  (t, e) => {
                    ...
                    return n
                      ? e.compose(
                          new (U())().retain(e.length(), { [W.blotName]: n })
                        )
                      : e;
                  },
                ],
          ...
          buildPickers(t, e) {
            (this.pickers = Array.from(t).map((t) => {
              if (
                ...
                (null == t.querySelector("option") && Zt(t, vt),
            ...
            switch (this.root.getAttribute("data-mode")) {
              case "link": {
                ...
                this.linkRange
                  ...
                  : (this.restoreFocus(),
                    this.quill.format("link", t, bt.Z.sources.USER)),
