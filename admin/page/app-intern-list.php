...
<body class="layout-boxed" data-bs-spy="scroll" data-bs-target="#navSection" data-bs-offset="140">
                ...
                <div class="middle-content container-xxl p-0">
                    ...
                    <div class="page-meta">
                        <div class="d-flex justify-content-between">
                            ...
                            <h2 class="title-form">รายชื่อนักศึกษาฝึกงานทั้งหมด</h2>
                            <a href="app-add-intern.php" class="btn btn-success d-flex align-items-center justify-content-center">
                                ...
                                <span class="btn-text-inner form-title">เพิ่มผู้ใช้นักศึกษาใหม่</span>
                            </a>
                        ...
                        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                            <div class="widget-content widget-content-area br-8">
                                ...
                                $sql = "SELECT user.*, department.*, position.*
                                        ...
                                        WHERE user.User_Type NOT IN ('superadmin', 'admin', 'officer')
                                        ORDER BY 
                                            user.User_ID
                                        ";
                                $result = $conn->query($sql);
                                ?>
                                <table id="intern-list" class="table dt-table-hover" style="width:100%">
                                    <thead>
                                        <tr>
                                            ...
                                            while ($row = $result->fetch_assoc()) { ?>
                                                <tr data-id="<?= $row['User_ID'] ?>">
                                                    ...
                                                    if ($row['User_Type'] == 'intern') {
                                                        echo "<td><span class='badge badge-success'>นักศึกษาฝึกงาน</span></td>";
                                                    } else {
                                                    ...
                                                    <td class="text-center">
                                                        <div class="d-flex justify-content-center align-items-center">
                                                            <a href="app-edit-intern.php?User_ID=<?= $row['User_ID'] ?>" class="bs-tooltip me-1" data-bs-toggle="tooltip" data-bs-placement="top" title="แก้ไข" data-original-title="Edit">
    ...
    <script>
        $(document).ready(function() {
            internList = $('#intern-list').DataTable({
        ...
        `);
            ...
            $('#intern-list').on('change', '.child-chk', function() {
                                ...
                                .done(function(response) {
                                    ...
                                    if (data.success) {
                                        Swal.fire({
                                            ...
                                            document.location.href = 'app-intern-list.php'; // ไปที่หน้าโปรเจคหลังจากลบสำเร็จ
                                        });
                                    } else {
